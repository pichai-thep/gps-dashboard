...
async function saveMileage() {
  ...
  await updateMileage(form.imei, Number(form.current_mileage))
...
async function removeGroup() {
  ...
  await deleteVehicleGroup(selectedMoveGroup.value)
  ...
  <div class="vehicle-page">
    ...
    <div class="toolbar card compact-toolbar">
      ...
      >
        ...
        {{ showGroupPanel ? 'Hide Groups' : 'Groups' }}
      </button>
    </div>
...
.compact-toolbar .p-button,
.sub-toolbar .p-button {
  height: 34px;
  font-size: 0.85rem;
}

.compact-toolbar .p-inputtext,
.sub-toolbar .p-inputtext,
.sub-toolbar .p-dropdown {
  height: 34px;
  font-size: 0.85rem;
}
