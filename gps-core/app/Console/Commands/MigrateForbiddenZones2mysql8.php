...
/*
test:
php artisan gps:migrate-forbidden-zones-mysql8 --dry-run
php artisan gps:migrate-forbidden-zones-mysql8 "CUSTOMER NAME" --dry-run

real:
php artisan gps:migrate-forbidden-zones-mysql8
php artisan gps:migrate-forbidden-zones-mysql8 "CUSTOMER NAME"
*/

class MigrateForbiddenZones2mysql8 extends Command
{
    protected $signature = 'gps:migrate-forbidden-zones-mysql8
